...
import uk.co.itmoore.intellisubsteps.psi.SubstepsPsiElement;
 ...
 * @author yole
 */
public abstract class SubstepsPsiElementBase extends ASTWrapperPsiElement implements SubstepsPsiElement {
  private static final TokenSet TEXT_FILTER = TokenSet.create(SubstepsTokenTypes.TEXT);
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof SubstepsElementVisitor) {
      acceptSubsteps((SubstepsElementVisitor) visitor);
    }
    else {
  ...
  protected abstract void acceptSubsteps(SubstepsElementVisitor SubstepsElementVisitor);
}
